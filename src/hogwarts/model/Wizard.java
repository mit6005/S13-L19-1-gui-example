...
public class Wizard {
     ...
     * @param photo URL of the wizard's profile photo, must be != null
     */
    public Wizard(Castle castle, House house, String name, URL photo) {
        this.castle = castle;
        this.house = house;
        this.name = name;
        this.photo = photo;
    ...
    /**
     * @return URL to wizard's profile photo
     */
    public URL getPhoto() {
        synchronized (castle) {
            return photo;
